package s07150750.gdemec.edu.cn.mymap;
...
public class MainActivity extends Activity {
    ...
    private void setOverlay() {
        ...
        OverlayOptions option = new MarkerOptions().position(dajidian).icon(bitmapDescriptor);
        mMarkerA = (Marker) baiduMap.addOverlay(option);
    }
